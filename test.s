...
%define SOB_NIL_ADDRESS const_tbl+8*0
%define SOB_FALSE_ADDRESS const_tbl+8*5
%define SOB_TRUE_ADDRESS const_tbl+8*6
...
MAKE_NIL_VOID rax, T_NIL
	mov [SOB_NIL_ADDRESS], rax
	
MAKE_RATIONAL_ 1, 1, [const_tbl +8*1]
mov rbx, [const_tbl +8*1]
mov rcx, [const_tbl +8*0]
	MAKE_PAIR (rax, rbx, rcx)
	
	mov [const_tbl + 8* 2 ], rax
	
mov rbx, [const_tbl +8*0]
mov rcx, [const_tbl +8*2]
	MAKE_PAIR (rax, rbx, rcx)
	
	mov [const_tbl + 8* 3 ], rax
	
MAKE_NIL_VOID rax, T_VOID
